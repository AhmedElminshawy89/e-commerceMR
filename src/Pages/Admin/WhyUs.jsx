...
const WhyUs = () => {
  ...
  const [saveServices , {isLoading:loadingSave}] = useSaveWhyUsMutation();
  const [updateServices, {isLoading:loading}] = useUpdateWhyUsMutation();
  const [delServices, {isLoading:loadingDel}] = useDelWhyUsMutation();
  const { data: about, error, isLoading ,refetch} = useShowAllAdminWhyUsQuery(currentPage); 
      ...
      <StyledModal open={isModalVisible} onClose={handleCloseModal}>
        <StyledBox>
          <Typography variant="h6" gutterBottom>
            {editingCategory ? "Edit Why Us" : "Add Why Us"}
          </Typography>
