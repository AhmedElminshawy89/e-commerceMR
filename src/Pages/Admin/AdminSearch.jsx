...
import { useAddAdminMutation, useUpdateAdminMutation  ,useForgetPasswordAdminMutation, useDelAdminMutation, useLazyShowAdminSearchQuery} from "../../app/Api/Admin";
import {
  Box,
  Button,
  Dialog,
...
const AdminSearch = () => {
  ...
  const [triggerSearch, { data, isLoading, refetch }] = useLazyShowAdminSearchQuery();
  ...
  return (
    ...
    <div style={{display:'flex',gap:5,marginBottom:20}}>
        ...
        />
        <Button onClick={handleSearch} color='primary' variant="outlined" disabled={isLoading}>
